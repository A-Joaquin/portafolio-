      ...
      >
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Email */}
            <div>
              <h3 className="font-mono mb-4" style={{ color: '#00FF41', textShadow: '0 0 8px rgba(0, 255, 65, 0.5)' }}>Email</h3>
              <a
                href="mailto:arturoveliz159@gmail.com"
                className="font-mono transition-all no-underline"
                style={{ color: '#FFFFFF' }}
                onMouseEnter={(e) => {
            ...
            {/* Social */}
            <div>
              <h3 className="font-mono mb-4" style={{ color: '#00FF41', textShadow: '0 0 8px rgba(0, 255, 65, 0.5)' }}>Social</h3>
              <div className="flex flex-col gap-3">
                ...
                <a
                  ...
                  className="flex items-center gap-3 font-mono transition-all no-underline"
                  style={{ color: '#FFFFFF' }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.color = '#FF6B00';
                    e.currentTarget.style.textShadow = '0 0 10px rgba(255, 107, 0, 0.8)';
